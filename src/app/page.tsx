  ...
  return (
    <div className="flex h-screen justify-center items-center bg-gray-700">
      ...
      >
        <div className="mb-4">
          <label
            className="block text-gray-700 font-bold mb-5 text-lg tracking-wider"
            htmlFor="game-room-id"
          >
            Game Room ID
          </label>
          <input
            className="border rounded-md w-full h-14 py-2 px-3 mb-6 text-gray-700 ring-2 focus:ring-lime-500 hover:ring-lime-500 focus:outline-none focus:shadow-outline tracking-widest"
            id="game-room-id"
            type="text"
            placeholder="5wec1"
          />
